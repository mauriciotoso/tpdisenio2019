...
public class ValorPorcentualDTO {
	...
	private float valorPorcentualDosSiniestros;
	private float valorPorcentualTresSiniestros;
	...
	public ValorPorcentualDTO(float valorPorcentualKmAnio, float valorPorcentualGarage, float valorPorcentualAlarma,
			float valorPorcentualRastreoVehicular, float valorPorcentualTuercasAntirrobo,
			float valorPorcentualSinSiniestro, float valorPorcentualUnSiniestro, float valorPorcentualDosSiniestros,
			float valorPorcentualTresSiniestros, float valorPorcentualHijo, float valorPorcentualModelo,
			float valorPorcentualLocalidad, float valorPorcentualTipoCobertura, float valorPorcentualMedidasSeguridad,
			float derechosEmision) {
		super();
		...
		this.valorPorcentualRastreoVehicular = valorPorcentualRastreoVehicular;
		...
		this.valorPorcentualDosSiniestros = valorPorcentualDosSiniestros;
		this.valorPorcentualTresSiniestros = valorPorcentualTresSiniestros;
	...
	public float getValorPorcentualRastreoVehicular() {
		return valorPorcentualRastreoVehicular;
	}

	public void setValorPorcentualRastreoVehicular(float valorPorcentualRastreoVehicular) {
		this.valorPorcentualRastreoVehicular = valorPorcentualRastreoVehicular;
	}
	...
	public float getValorPorcentualDosSiniestros() {
		return valorPorcentualDosSiniestros;
	}

	public void setValorPorcentualDosSiniestros(float valorPorcentualDosSiniestros) {
		this.valorPorcentualDosSiniestros = valorPorcentualDosSiniestros;
	}

	public float getValorPorcentualTresSiniestros() {
		return valorPorcentualTresSiniestros;
	}

	public void setValorPorcentualTresSiniestros(float valorPorcentualTresSiniestros) {
		this.valorPorcentualTresSiniestros = valorPorcentualTresSiniestros;
	}
